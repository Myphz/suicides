...
plt.plot(time, world_suicides_per_year, color="red", label="Total suicides")
plt.plot(time, world_male_suicides_per_year, color="blue", label="Male suicides")
plt.plot(time, world_female_suicides_per_year, color="purple", label="Female suicides")
plt.xticks([x for x in range(0, len(yrs), 5)], yr[::5], fontsize=15)
...
plt.plot(time, world_male_suicides_ratio, color="blue", label="Male suicides percentage")
plt.plot(time, world_female_suicides_ratio, color="purple", label="Female suicides percentage")
plt.xticks([x for x in range(0, len(yrs), 5)], yr[::5], fontsize=15)
plt.yticks([_ for _ in range(0, 101, 10)], [str(s) + "%" for s in range(0, 101, 10)], fontsize=15)
plt.xlabel("Year", labelpad=25, fontsize=25)
plt.ylabel("% of suicides", labelpad=50, fontsize=25)
